...
export const addButton = async (renderer: THREE.WebGLRenderer, parent?: HTMLElement, style?: string) => {
...
export const initXR = (renderer: THREE.WebGLRenderer, parent?: HTMLElement) => {
  /*
